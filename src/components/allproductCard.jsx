    ...
    <div className="sm:w-[270px] sm:min-w-[270px] w-full h-full flex flex-col sm:items-start items-center gap-4 product">
      ...
      <div className="flex flex-col items-start gap-2 sm:w-[full] w-[70%] sm:max-w-full max-w-[260px] ">
        ...
        <div className="flex gap-4 mt-2 w-full">
          {isadded ? (
            <button className="bg-grey text-blue-600 px-2 py-2 rounded-lg font-semibold shadow text-sm">
              Added to Cart
            </button>
          ) : (
            <button
              className="bg-blue-600 w-auto hover:bg-blue-700 transition text-white px-2 py-2  text-sm rounded-lg font-semibold shadow cursor-pointer"
